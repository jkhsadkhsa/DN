...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="main">            
            ...
            <form action="${pageContext.request.contextPath}/feeController/updFee.do" method="" class="main_form">
                <div class="text_info clearfix"><span>资费ID：</span></div>
                <div class="input_info">
                    <input type="text" class="width300" name="fid" value="${feeByFid.fid}"/>
                    <span class="required">*</span>
                    <div class="validate_msg_short">1-600之间的整数</div>
                </div>
                <div class="text_info clearfix"><span>资费名称：</span></div>
                <div class="input_info">
                    <input type="text" class="width300" name="fname" value="${feeByFid.fname}"/>
                    <span class="required">*</span>
                    <div class="validate_msg_short">50长度的字母、数字、汉字和下划线的组合</div>
                </div>
                <div class="text_info clearfix"><span>基本时长：</span></div>
                <div class="input_info">
                    <input type="text" value="${feeByFid.fhour}" name="fhour" class="width100" />
                ...
                <div class="input_info">
                    <input type="text" value="${feeByFid.fbfee}" name="fbfee" class="width100" />
                ...
                <div class="input_info">
                    <input type="text" value="${feeByFid.fdfee}" name="fdfee" class="width100" />
                ...
                <div class="input_info_high">
                    <textarea class="width300 height70" name="fcdate">${feeByFid.fcdate}</textarea>
                    <div class="validate_msg_short">100长度的字母、数字、汉字和下划线的组合</div>
                </div>
                <div class="text_info clearfix"><span>开通时间：</span></div>
                <div class="input_info_high">
                    <textarea class="width300 height70" name="fkdate">${feeByFid.fkdate}</textarea>
                    <div class="validate_msg_short">100长度的字母、数字、汉字和下划线的组合</div>
                </div>
                <div class="text_info clearfix"><span>状态：</span></div>
                <div class="input_info">
                    <input type="text" value="${feeByFid.fstate}" name="fstate" class="width100" />
                </div>
